...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\beca_talento>
 */
class BecaTalentoFactory extends Factory
{
    /**
    ...
    public function definition()
    {
        return [
            ...
            'inscripcion_federacion'=>$this->faker->inscripcion_federacion,
            ...
            'zona_participacion_talento'=>$this->faker->zona_participacion_talento,
            'frecuencia_practica_talento'=>$this->faker->frecuencia_practica_talento,
            'participacion_institucion_talento'=>$this->faker->participacion_institucion_talento,
            'premiacion_talento'=>$this->faker->premiacion_talento,
